...
void run_cpu_tests(vector<vector<int>> arrays, vector<int> (*algo)(int n, vector<int>)) {
    ...
    double time_seconds = duration_cast<duration<double>>(end_time - start_time).count();
